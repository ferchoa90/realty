...
$this->title = "Editar consultorio";
$this->params['breadcrumbs'][] = $this->title;

$urlpost='formeditarconsultorio';
...
$div= new Bloques;
 ...
 $contenido=$objeto->getObjetosArray(
    array(
        ...
        array('tipo'=>'input','subtipo'=>'cajatexto', 'nombre'=>'nombres', 'id'=>'nombres', 'valor'=>$model->nombre,'etiqueta'=>'Nombres: ', 'onchange'=>'', 'clase'=>'', 'style'=>'', 'icono'=>'lapiz','boxbody'=>false, 'col'=>'col-12 col-md-6', 'adicional'=>''),
...
$form = ActiveForm::begin(['id'=>'frmDatos']);
 echo $div->getBloqueArray(
    array(
        array('tipo'=>'bloquediv','nombre'=>'div1','id'=>'div1','titulo'=>'Datos consultorio: '.$model->id,'clase'=>'col-md-9 col-xs-12 ','style'=>'','col'=>'','tipocolor'=>'','adicional'=>'','contenido'=>$contenido.$botonC),
