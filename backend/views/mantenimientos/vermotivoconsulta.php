...
$this->title = "Ver motivo consulta";
$this->params['breadcrumbs'][] = ['label' => 'Motivo Consultas', 'url' => ['motivoconsulta']];
...
$contenido=$contenidoClass->getContenidoArrayr(
        array(
            ...
            array('tipo'=>'div','nombre'=>'desc', 'id' => 'desc', 'titulo'=>'Descripción:','contenido'=>$data->descripcion, 'col'=>'col-12 col-md-9','clase'=>'', 'style'=>'', 'tipocolor'=>'azul', 'icono'=>'regresar','adicional'=>''),
        )
    );
