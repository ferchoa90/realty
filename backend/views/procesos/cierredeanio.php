...
echo $botones->getBotongridArray(
    array(array('tipo'=>'link','nombre'=>'ver', 'id' => 'new', 'titulo'=>' Nuevo cierre', 'link'=>'nuevocierre', 'onclick'=>'' , 'clase'=>'', 'style'=>'', 'col'=>'', 'tipocolor'=>'verde', 'icono'=>'nuevo','tamanio'=>'pequeño',  'adicional'=>'')));
...
$columnas= array(
    ...
    array('columna'=>'Periodo', 'datareg' => 'periodo', 'clase'=>'', 'estilo'=>'', 'ancho'=>''),
...
echo $grid->getGrid(
        array(
            array('tipo'=>'datagrid','nombre'=>'table','id'=>'table','columnas'=>$columnas,'clase'=>'','style'=>'','col'=>'','adicional'=>'','url'=>'cierreanioreg')
        )
);
