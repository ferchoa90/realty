...
$this->title = "Ver Retención CXC";
$this->params['breadcrumbs'][] = ['label' => 'Retenciones cxc', 'url' => ['retencionescxc']];
...
$contenido='<div style="line-height:30px;" class="row"><div class="col-4 col-md-4"><b>Número:  </b>'.$retencion->numero.'</div>';
$contenido.='<div class="col-4 col-md-4"><b>Fecha:  </b>'.$retencion->fecha.'<br></div>';
$contenido.='<div class="col-12 col-md-12"><b>Proveedor:  </b>'.$retencion->cliente0->razonsocial.'</div>';
$contenido.='<div class="col-12 col-md-12"><b>Proveedor:  </b>'.$retencion->cliente0->direccion.'</div>';
